...
| `DEX`   | `ONCHAIN`, `POOLS` | yes      | On-chain / DEX liquidity pools for an asset — price, TVL, 24h volume & fee tier per pool, with a live/synthetic data-honesty badge (synthetic until an on-chain source is configured). |
