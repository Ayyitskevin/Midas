...
| `BACKTEST` | `BT`, `STRATEGY`, `SMACROSS`, `RSIBT`, `BOLLBT` | yes | Strategy backtest — SMA-crossover, RSI mean-reversion or Bollinger-band reversion: strategy equity vs buy & hold with total return, max drawdown, win rate & trade count. |
