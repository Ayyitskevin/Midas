...
export const MODULE_COMPONENTS: Record<ModuleCode, LazyExoticComponent<ComponentType<ModuleProps>>> = {
  ...
  SVAL: mod(() => import('./SolanaValidatorsModule'), 'SolanaValidatorsModule'),
  SSTAKE: mod(() => import('./SolanaStakingModule'), 'SolanaStakingModule'),
  SPL: mod(() => import('./SolanaTokenModule'), 'SolanaTokenModule'),
  SJUP: mod(() => import('./SolanaSwapModule'), 'SolanaSwapModule'),
  SOLMKT: mod(() => import('./SolanaMarketModule'), 'SolanaMarketModule'),
  ...
  XARB: mod(() => import('./VenueArbModule'), 'VenueArbModule'),
  ...
  OPTC: mod(() => import('./OptionsChainModule'), 'OptionsChainModule'),
  ...
  ORD: mod(() => import('./OrdersModule'), 'OrdersModule'),
  ...
  SYS: mod(() => import('./SysModule'), 'SysModule'),
  KEYS: mod(() => import('./KeysModule'), 'KeysModule'),
  ...
  KELT: mod(() => import('./KeltnerModule'), 'KeltnerModule'),
  ...
  DPO: mod(() => import('./DpoModule'), 'DpoModule'),
  COPP: mod(() => import('./CoppockModule'), 'CoppockModule'),
  BOP: mod(() => import('./BopModule'), 'BopModule'),
  ADL: mod(() => import('./AdlModule'), 'AdlModule'),
  CMF: mod(() => import('./CmfModule'), 'CmfModule'),
  ...
  RWI: mod(() => import('./RwiModule'), 'RwiModule'),
  STC: mod(() => import('./StcModule'), 'StcModule'),
  TSI: mod(() => import('./TsiModule'), 'TsiModule'),
  CRSI: mod(() => import('./CrsiModule'), 'CrsiModule'),
  KST: mod(() => import('./KstModule'), 'KstModule'),
  KVO: mod(() => import('./KvoModule'), 'KvoModule'),
  RVGI: mod(() => import('./RvgiModule'), 'RvgiModule'),
  ...
  MCG: mod(() => import('./McginleyModule'), 'McginleyModule'),
