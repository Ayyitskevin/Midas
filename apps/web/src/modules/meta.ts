...
export const MODULE_META: Record<ModuleCode, ModuleMeta> = {
  ...
  SOLNET: { code: 'SOLNET', title: 'Solana Network', w: 6, h: 10, minW: 4, minH: 6 },
  ...
  SPL: { code: 'SPL', title: 'SPL Token', w: 5, h: 9, minW: 4, minH: 6 },
  SJUP: { code: 'SJUP', title: 'Solana Swap Quote', w: 5, h: 9, minW: 4, minH: 6 },
  SOLMKT: { code: 'SOLMKT', title: 'Solana Market', w: 7, h: 12, minW: 5, minH: 6 },
  ...
  AO: { code: 'AO', title: 'Awesome Oscillator', w: 4, h: 12, minW: 3, minH: 6 },
  AC: { code: 'AC', title: 'Accelerator Oscillator', w: 4, h: 12, minW: 3, minH: 6 },
  CHO: { code: 'CHO', title: 'Chaikin Oscillator', w: 4, h: 12, minW: 3, minH: 6 },
