 ...
 * open the corresponding panel — **additively**, on top of whatever workspace
 * restores — then strip the fragment so a reload (or sharing the live URL)
 * doesn't replay it. Invalid or unknown links are ignored.
 */
